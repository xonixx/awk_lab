...
"object" == $1 && !isString() { Mode=$1; WasVal=0; Stack[++Depth]="object"; p("{"); next; }
"list"   == $1 && !isString() { Mode=$1; WasVal=0; Stack[++Depth]="list";   p("["); next; }
...
"end"    == $1 && !isString() { p(Stack[Depth--]=="object" ? "}" : "]"); next; }
